        ...
        <Row gutter={24}>
          {bookings
            ...
            .sort((a, b) => {
              ...
              return moment(b.show.time, "hh:mm A").diff(
                moment(a.show.time, "hh:mm A")
              );
            })
            .map((booking) => {
              return (
                <Col key={booking._id} xs={{ span: 24 }} lg={{ span: 12 }}>
                  <Card className="mb-3">
                    <div className="d-flex flex-column-mob">
                      <Flex
                        gap="small"
                        className="flex-column-mob"
                        align="center"
                      >
                        <div
                          className="show-details flex-1"
                          style={{ padding: "10px" }}
                        >
                          ...
                          <Flex gap="small" vertical>
                            ...
                            <p>
                              Seat(s) no.: <b>{booking.seats.join(", ")}</b>
                            </p>
                            <p>
                              Date & Time:{" "}
                              <b>
